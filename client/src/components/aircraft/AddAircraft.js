...
export default function AddAircraft({ userId, setAddAircraftActive, fetchAircraft }) {
    ...
    return(
        <>
            <div className="modalOverlay" onClick={() => {setAddAircraftActive(false)}}></div>
            <div className="addAircraft">
                <div className="closeModal">
                    <FontAwesomeIcon className={"icon"} icon={faXmark} onClick={() => {setAddAircraftActive(false)}}/>
                </div>
                <h3>Add Aircraft</h3>
